...
import { MultiSig, MultiSig__factory, MultiSigRecovery__factory } from "../types";
import { ethers } from "hardhat";

export function shouldBehaveLikeMultiSigRecovery() {
  ...
  let MultiSigFactory: MultiSigRecovery__factory;
  ...
  beforeEach(async () => {
    ...
    MultiSigFactory = await ethers.getContractFactory("MultiSigRecovery");
